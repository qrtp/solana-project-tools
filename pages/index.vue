<template >
    <div>
        ...
        <div class="block text-gray-700 text-sm mb-2">
            Sales tracking continuously monitors your NFT collection for new mints and secondary market sales. Whenever activity is detected, we update your collection page and post a message to our community <a :href="'https://twitter.com/'+this.$config.twitter_bot">Twitter sales tracking bot</a>. 
            <br>
            <br>
